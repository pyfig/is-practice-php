...
function vercel_render_root_placeholder(array $manifest): void
{
    ...
    echo '    <title>PHP Assignments</title>' . "\n";
    echo '    <link rel="stylesheet" href="/assets/launchpad.css">' . "\n";
    echo '</head>' . "\n";
    echo '<body>' . "\n";
    echo '    <header class="launchpad-header">' . "\n";
    echo '        <a href="/" class="home-logo" data-home-logo>' . "\n";
    echo '            <svg class="home-logo-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' . "\n";
    echo '                <rect x="3" y="3" width="7" height="7" rx="1"/>' . "\n";
    echo '                <rect x="14" y="3" width="7" height="7" rx="1"/>' . "\n";
    echo '                <rect x="3" y="14" width="7" height="7" rx="1"/>' . "\n";
    echo '                <rect x="14" y="14" width="7" height="7" rx="1"/>' . "\n";
    echo '            </svg>' . "\n";
    echo '            <span>PHP Assignments</span>' . "\n";
    echo '        </a>' . "\n";
    echo '    </header>' . "\n";
