...
<head>
    ...
    <title>02 Control Structures</title>
...
<main class="assignment-page">
    <article class="assignment-shell">
        <h1 class="assignment-title">02 Control Structures</h1>
        <p class="assignment-description">Season-related CLI output rendered inside the shared launchpad shell.</p>
