...
$body = '<h1>Практика по сессиям в PHP</h1>'
    . '<p>Маршрут приложения: <code>' . escape_html(app_url()) . '</code></p>'
    ...
    . '<p><a href="' . escape_html(app_url('/test.php')) . '">Перейти на test.php</a></p></section>'
    ...
    . '<li><a href="' . escape_html(app_url('/email-step1.php')) . '">Передача email между формами</a></li>'
    . '<li><a href="' . escape_html(app_url('/profile-step1.php')) . '">Форма с предзаполнением Name / Age / City</a></li>'
    . '<li><a href="' . escape_html(app_url('/quiz-step1.php')) . '">Многостраничный мини-квиз</a></li>'
    . '<li><a href="' . escape_html(app_url('/logout.php')) . '">Выход и очистка состояния</a></li>'
    . '</ul></nav></section>';
